...
# Creamos el topic
create_topic1 = "gnome-terminal -- bash -c '/home/joanclq/kafka/bin/kafka-topics.sh --create --topic mapas-topic --bootstrap-server " + IP_KAFKA + ":9092; exec bash'"
create_topic2 = "gnome-terminal -- bash -c '/home/joanclq/kafka/bin/kafka-topics.sh --create --topic movimientos-topic --bootstrap-server " + IP_KAFKA + ":9092; exec bash'"
