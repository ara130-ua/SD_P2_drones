...
# Creamos el topic
create_topic1 = "gnome-terminal -- bash -c '/home/joanclq/kafka/bin/kafka-topics.sh --create --topic mapas1-topic --bootstrap-server " + IP_KAFKA + ":9092 && exit; exec bash'"
create_topic2 = "gnome-terminal -- bash -c '/home/joanclq/kafka/bin/kafka-topics.sh --create --topic movimientos1-topic --bootstrap-server " + IP_KAFKA + ":9092 && exit; exec bash'"
...
# Borramos el topic
delete_topic1 = "gnome-terminal -- bash -c '/home/joanclq/kafka/bin/kafka-topics.sh --delete --topic mapas1-topic --bootstrap-server " + IP_KAFKA + ":9092 && exit; exec bash'"
delete_topic2 = "gnome-terminal -- bash -c '/home/joanclq/kafka/bin/kafka-topics.sh --delete --topic movimientos1-topic --bootstrap-server " + IP_KAFKA + ":9092 && exit; exec bash'"
